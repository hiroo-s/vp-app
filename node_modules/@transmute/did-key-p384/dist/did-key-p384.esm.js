...
var privateKeyJwkToPrivateKeyBase58 = function privateKeyJwkToPrivateKeyBase58(privateKeyJwk) {
  return encode(base64url.toBuffer(privateKeyJwk.d));
};
var privateKeyBase58toPrivateKeyJwk = function privateKeyBase58toPrivateKeyJwk(privateKeyBase58, publicKeyBase58) {
  ...
  return _extends({}, publicKeyJwk, {
    d: base64url.encode(decode(privateKeyBase58))
  });
};
...
var P384KeyPair = /*#__PURE__*/function () {
  function P384KeyPair(options) {
    ...
    var publicKeyBase58 = encode(this.publicKeyBuffer);
  ...
  P384KeyPair.fingerprintFromPublicKey = function fingerprintFromPublicKey(_ref) {
    ...
    var pubkeyBytes = decode(publicKeyBase58);
  ...
  P384KeyPair.fromFingerprint = function fromFingerprint(_ref2) {
    ...
    var buffer = decode(fingerprint.substr(1)); // https://github.com/multiformats/multicodec/blob/master/table.csv#L77

    if (buffer[0] === 0xef && buffer[1] === 0x01) {
      var publicKeyBase58 = encode(buffer.slice(2));
  ...
  _proto.addEncodedPublicKey = function addEncodedPublicKey(publicKeyNode) {
    publicKeyNode.publicKeyBase58 = encode(this.publicKeyBuffer);
  ...
  _proto.toJwk = function toJwk(exportPrivate) {
    ...
    if (exportPrivate) {
      return privateKeyBase58toPrivateKeyJwk(encode(this.privateKeyBuffer), encode(this.publicKeyBuffer));
    }

    return publicKeyBase58toPublicKeyJwk(encode(this.publicKeyBuffer));
  };
  ...
  _proto.signer = function signer() {
    ...
    var privateKeyBase58 = encode(this.privateKeyBuffer);
    var publicKeyBase58 = encode(this.publicKeyBuffer);
  ...
  _proto.deriveSecret = function deriveSecret$1(_ref6) {
    ...
    try {
      ...
      var privateKeyBase58 = encode(_this2.privateKeyBuffer);
      var publicKeyBase58 = encode(_this2.publicKeyBuffer);
      var privateKeyJwk = privateKeyBase58toPrivateKeyJwk(privateKeyBase58, publicKeyBase58);
  ...
  _createClass(P384KeyPair, [{
    key: "publicKey",
    get: function get() {
      return encode(this.publicKeyBuffer);
    }
  }, {
    key: "privateKey",
    get: function get() {
      return encode(this.privateKeyBuffer);
    }
  }]);
...
export { ES384, P384KeyPair, driver, keyUtils };
//# sourceMappingURL=did-key-p384.esm.js.map
